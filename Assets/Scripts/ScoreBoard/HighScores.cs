...
{
    const string privateCode = "8UOO_4d9BESigwXf1VvmpQyrO9H1cWXUKfpc1-k4BeDg";  //Key to Upload New Info
    const string publicCode = "6158e9298f40bb0e2882026a";   //Key to download
